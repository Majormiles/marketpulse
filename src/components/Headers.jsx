...
import './Headers.css'; // Import the CSS file here
...
const Headers = () => {
    ...
    return (
        <div className='w-full bg-white'>
            <div className='header-top bg-[#414E58] md-lg:hidden  fixed w-full z-50 top-0'>
                <div className='w-[85%] lg:w-[90%] mx-auto'>
                    <div className='flex w-full justify-between items-center h-[35px] text-slate-500'>
                        <ul className='flex justify-start items-center gap-8 text-[#fff] '>
                            <li className='flex relative justify-center items-center gap-2 text-sm after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px]'>
                                <span><GrMail /></span>
                                <span>marketpulse@mail.com</span>
                            </li>
            ...
            <div className='w-white bg-[#FCF8F5] md:mt-0 md:p-5 p-5 mb-4 mt-6 '>
                <div className='w-[85%] lg:w-[90%] mx-auto '>
                    <div className='h-[70px] md-lg:h-[100px] flex justify-between items-center flex-wrap'>
                        ...
                        <div className='md-lg:w-full w-9/12 '>
                            <div className='flex justify-between md-lg:justify-center items-center flex-wrap pl-8'>
                                <ul className='flex justify-start items-start gap-8 text-sm font-bold uppercase md-lg:hidden'>
                                    ...
                                    <li>
                                        <Link  className={`p-2 block ${pathname === '/about' ? 'text-[#fd7700]' : 'text-slate-600'}`}>About</Link>
                                    </li>
                                    <li>
                                        <Link to='/contacts' className={`p-2 block ${pathname === '/contact' ? 'text-[#fd7700]' : 'text-slate-600'}`}>Contact</Link>
                                    </li>
                                </ul>
            ...
            <div className='hidden md-lg:block  '>
                <div onClick={() => setShowShidebar(true)} className={`fixed duration-150 transition-all ${showShidebar ? 'invisible' : 'visible'} hidden md-lg:block w-screen h-screen bg-[rgba(0,0,0,0.5)] top-0 left-0 z-20`}>
                </div>
                <div className={`w-[300px] z-[9999] transition-all duration-200 fixed  ${showShidebar ? '-left-[300px]' : 'left-0'} top-0 overflow-y-auto bg-white h-screen py-5 px-8`}>
                    <div className='flex justify-start flex-col gap-6'>
                        ...
                        <ul className='flex flex-col justify-start items-start  text-md font-semibold uppercase'>
                            ...
                            <li>
                                <Link  className={`py-2 block ${pathname === '/about' ? 'text-[#fd7700]' : 'text-slate-600'}`}>About</Link>
                            </li>
                            <li>
                                <Link to='/contacts' className={`py-2 block ${pathname === '/contact' ? 'text-[#fd7700]' : 'text-slate-600'}`}>Contact</Link>
                            </li>
                        </ul>
                        ...
                        <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                            ...
                            <div className='flex justify-end flex-col gap-1'>
                                <h2 className='text-sm font-medium text-slate-700'>+233247466205</h2>
                        ...
                        <ul className='flex flex-col justify-start items-start gap-3 text-[#1c1c1c]'>
                            <li className='flex justify-start items-center gap-2  text-sm'>
                                <span><GrMail /></span>
                                <span>globalexhub@mail.com</span>
                            </li>
                ...
                <div className='flex w-full flex-wrap md-lg:gap-8'>
                    <div className='w-3/12 md-lg:w-full' >
                        <div className='bg-white relative'>
                            <div onClick={() => setCategoryShow(!categoryShow)} className='h-[50px] rounded bg-[#F97316] text-white flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer'>
                            ...
                            <div className={`${categoryShow ? 'h-0' : 'h-[300px]'} overflow-hidden transition-all md-lg:relative duration-500 absolute z-[99999] bg-white w-full border-x`}>
                    ...
                    <div className='category w-9/12 pl-8 md-lg:pl-0 md-lg:w-full'>
                        <div className='flex flex-wrap w-full justify-between items-center md-lg:gap-6'>
                            <div className=' w-8/12 md-lg:w-full'>
                                <div className='flex border h-[50px] items-center relative gap-5'>
                                    ...
                                    <input className='w-full relative bg-transparent  text-slate-500 outline-0 px-3 h-full' onChange={(e) => setSearchValue(e.target.value)} type="text" name="" id="" placeholder='Search products...' />
                                    <button onClick={search} className='bg-[#F97316] rounded right-0 absolute px-8 h-full font-semibold uppercase text-white'>Search</button>
                                </div>
                            </div>
