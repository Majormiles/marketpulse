...
const Card = () => {
    ...
    return (
        <div>
            <Headers />
            <section className='bg-[url("https://marketpulse-oxxa.onrender.com/images/banner/card.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                                ...
                                <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
                                    {
                                        card_products.length > 0 && <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                                            ...
                                            <div className='flex justify-between items-center'>
                                                <span>Total</span>
                                                <span className='text-lg text-orange-500'>GH₵{price + shipping_fee}</span>
                                            </div>
