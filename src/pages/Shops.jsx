...
const Shops = () => {
    ...
    return (
        <div>
            <Headers />
            <section className='bg-[url("https://marketpulse-oxxa.onrender.com/images/banner/img2.gif")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
            ...
            <section className='py-16'>
                <div className='w-[85%] md:w-[90%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                    ...
                    <div className='w-full flex flex-wrap'>
                        <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 sticky top-0 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0'}`}>
                            ...
                            <div className='py-2 flex flex-col gap-5'>
                                ...
                                />
                                <div>
                                    <span className='text-red-500 font-bold text-lg'>GH₵{Math.floor(state.values[0])} - GH₵{Math.floor(state.values[1])}</span>
                                </div>
                            </div>
                            ...
                            <div className='py-5 flex flex-col text-sm gap-5 md:hidden'>
                                <Products title="Latest Products" products={latest_product.slice(0, 1)} />
                            </div>
